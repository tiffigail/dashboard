...
import { getPrimaryActiveSprint } from '../../services/sprintService';
...
function DynamicSprintDashboard() {
    ...
    const renderDashboard = () => {
        ...
        switch (axis) {
            case 'Physical':
                return <PhysicalDashboard sprint={activeSprint} />;
            
            case 'Gear':
                return <GearDashboard sprint={activeSprint} />;
            
            // TODO: Add other axes as we build them
            // case 'Financial':
            //     return <FinancialDashboard sprint={activeSprint} />;
            
            // case 'Environment':
            //     return <EnvironmentDashboard sprint={activeSprint} />;
            ...
            default:
                ...
                return (
                    <div className={styles.container}>
                        ...
                        <PhysicalDashboard sprint={activeSprint} />
                    </div>
                );
        }
    };
