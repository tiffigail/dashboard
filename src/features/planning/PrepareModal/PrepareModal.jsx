...
import styles from '@/features/planning/PrepareModal/PrepareModal.module.css'; // The CSS file name also stays the same
...
function PrepareModal({ onClose, weeklyGoals }) {
    ...
    const handleAddTask = async () => {
        ...
        const newTaskData = {
            ...
            parentID: getWeekId(), parentType: "weeklyPlan",
