...
export const MUSCLE_BUILDING_PROGRAMS = [
...

  {
    ...
    exercises: [
      {
        exerciseId: 'scapular-wall-slides', exerciseName: 'Scapular Wall Slides',
        targetMuscle: 'serratus anterior', equipment: 'wall',
        weeklyProgression: {
          1: { sets: 3, reps: '10', weight: 'bodyweight', restSeconds: 60, notes: 'Learn the movement' },
          2: { sets: 3, reps: '12', weight: 'bodyweight', restSeconds: 60, notes: 'Focus on protraction' },
          3: { sets: 4, reps: '12', weight: 'bodyweight', restSeconds: 45 },
          4: { sets: 4, reps: '15', weight: 'bodyweight', restSeconds: 45 },
          5: { sets: 4, reps: '15', weight: 'light band', restSeconds: 45 },
          6: { sets: 4, reps: '15', weight: 'medium band', restSeconds: 45 },
          7: { sets: 5, reps: '12', weight: 'medium band', restSeconds: 45 },
          8: { sets: 5, reps: '15', weight: 'medium band', restSeconds: 30 },
        },
        formCues: ['Stand with back against wall', 'Elbows bent 90 degrees, backs of hands on wall', 'PROTRACT shoulders (push shoulder blades away from spine)', 'Slide arms up wall while maintaining protraction'],
      },
      {
      ...
      {
        exerciseId: 'bear-crawl', exerciseName: 'Bear Crawl',
        targetMuscle: 'serratus anterior stability', equipment: 'floor space',
        weeklyProgression: {
          1: { sets: 3, reps: '10 ft', weight: 'bodyweight', restSeconds: 60 },
          2: { sets: 3, reps: '15 ft', weight: 'bodyweight', restSeconds: 60 },
          3: { sets: 3, reps: '20 ft', weight: 'bodyweight', restSeconds: 45 },
          4: { sets: 3, reps: '20 ft', weight: 'bodyweight', restSeconds: 45 },
          5: { sets: 4, reps: '25 ft', weight: 'bodyweight', restSeconds: 45 },
          6: { sets: 4, reps: '30 ft', weight: 'bodyweight', restSeconds: 30 },
          7: { sets: 4, reps: '30 ft', weight: 'bodyweight', restSeconds: 30 },
          8: { sets: 5, reps: '40 ft', weight: 'bodyweight', restSeconds: 30 },
        },
        formCues: ['Hands and feet on ground, knees 1-2 inches off floor', 'Move forward by alternating hands and feet', 'Keep back flat, core braced', 'Maintain scapular protraction'],
      },
    ],

    weeklySchedule: {
      1: { name: 'Daily Session', exercises: ['scapular-wall-slides', 'serratus-punch', 'pushup-plus', 'bear-crawl'], focus: 'Activation and strengthening' },
    },
