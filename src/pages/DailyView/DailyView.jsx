...
import styles from '@/pages/DailyView/DailyView.module.css';
import Modal from '@/components/ui/Modal/Modal';
import AmRoutineForm from '@/features/planning/AmRoutineForm/AmRoutineForm';
import PmRoutineForm from '@/features/planning/PmRoutineForm/PmRoutineForm';
import FamilyCleanForm from '@/features/planning/FamilyCleanForm/FamilyCleanForm';
import StudyForm from '@/features/gear/StudyForm/StudyForm';
import ReadyForWorkForm from '@/features/planning/ReadyForWorkForm/ReadyForWorkForm';
import {LeaveWorkAtWork} from '@/features/lifemap/LeaveWorkAtWork/LeaveWorkAtWork';
import ContextMap from '@/features/lifemap/ContextMap/ContextMap';
import BreakAnalysisChart from '@/features/physical/BreakAnalysisChart/BreakAnalysisChart';
...
    ]);
 ...
 useEffect(() => {
    ...
    // == Modal Handlers ==
    const handleAmRoutineSubmit = () => { closeAmModal(); };
    const handlePmRoutineSubmit = () => { closePmModal(); };
    const handleFamilyCleanSubmit = () => { closeFamilyCleanModal(); };
    const handleStudySubmit = () => { closeStudyModal(); };
    const handleBudgetSubmit = () => { closeBudgetModal(); };
    const handleReadySubmit = () => { closeReadyModal(); };
    const handleLeaveWorkSubmit = () => { closeLeaveWorkModal(); };
